...
We compute the number of \ch{K+} ions by multiplying the intracellular concentration with the cell's volume to obtain $5 \times 10^{-11}\si{\mole}$ and $1 \times 10^{-12}\si{\mole}$ \ch{K+} ions respectively.
